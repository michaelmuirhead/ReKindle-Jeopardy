...
const QUESTION_BANK = {
  ...
  "Life of Jesus": {
    ...
    600: [
      ...
      { q: "Judas Iscariot prearranged a specific signal to help soldiers identify Jesus in the garden at night. What was this signal?", a: "A kiss (Matthew 26:48)" },
      ...
      { q: "The night before He died, Jesus broke bread and said 'This is my body.' What do Christians call this practice today?", a: "Communion (the Lord's Supper)" },
    ...
    800: [
      ...
      { q: "When soldiers came to arrest Jesus and a disciple drew a sword and cut off the ear of the high priest's servant, what did Jesus do immediately after?", a: "He healed the servant's ear (Luke 22:51)" },
    ...
    1000: [
      ...
      { q: "In John 21, after the resurrection, Jesus asked Peter the same question three times. What was the question?", a: "'Do you love me?' (John 21:15-17)" },
  ...
  "Women of the Bible": {
    ...
    1000: [
      ...
      { q: "This woman from Thyatira is condemned in Revelation 2 for leading God's people into sexual immorality and idol worship — compared to an Old Testament queen.", a: "'Jezebel' (Revelation 2:20)" },
  ...
  "Numbers & Facts": {
    ...
    600: [
      ...
      { q: "James 5:17 tells us Elijah prayed for drought and it did not rain. According to James and Luke, how long did the drought last?", a: "Three and a half years (42 months)" },
      { q: "How many 'I AM' statements does Jesus make in the Gospel of John?", a: "Seven (7)" },
      { q: "How many years did Solomon take to build the temple in Jerusalem?", a: "7 years (1 Kings 6:38)" },
      { q: "How many wise men visited baby Jesus? (Be careful — the Bible doesn't actually say!)", a: "The Bible never specifies a number — only that they brought three types of gifts" },
    ...
    800: [
      ...
      { q: "How many years did Jacob work to earn Rachel as his wife — and how many total did he end up working?", a: "14 years total (seven for Leah, seven more for Rachel)" },
      ...
      { q: "How many verses are in Psalm 119, making it the longest single chapter in the Bible?", a: "176 verses" },
    ...
    1000: [
      ...
      { q: "According to Revelation, how many gates does the New Jerusalem have?", a: "12 gates (Revelation 21:12)" },
  ...
  "The Early Church": {
    200: [
      ...
      { q: "According to Acts 2:42, the early church devoted themselves to four specific things. What were all four?", a: "Teaching, fellowship, breaking of bread, and prayer (Acts 2:42)" },
    ...
    600: [
      ...
      { q: "Saul's name changed to Paul. At what point in Acts does the name 'Paul' first appear?", a: "Acts 13:9" },
    ...
    1000: [
      ...
      { q: "The seven deacons chosen in Acts 6 were appointed to a specific task so the apostles could keep focusing on prayer and teaching. What was that task?", a: "Distributing food and waiting on tables for the widows (Acts 6:1-3)" },
  ...
  "Prophets": {
    ...
    800: [
      ...
      { q: "In the vision of the dry bones in Ezekiel 37, what did the bones represent?", a: "The nation of Israel in exile — spiritually dead but destined for restoration (Ezekiel 37:11)" },
      ...
      { q: "In one of Zechariah's night visions, a gold lampstand stands between two olive trees. God delivers a famous encouragement to Zerubbabel through this vision. What does God say?", a: "'Not by might nor by power, but by my Spirit,' says the Lord (Zechariah 4:6)" },
    ],
    1000: [
      ...
      { q: "Ezekiel saw four living creatures with four faces each. Name all four faces.", a: "Human, lion, ox, and eagle (Ezekiel 1:10)" },
      ...
      { q: "The prophet Hosea named his three children as symbolic messages to Israel. What were their names?", a: "Jezreel, Lo-Ruhamah, and Lo-Ammi (Hosea 1)" },
      { q: "Isaiah 53:5 says 'by His wounds we are healed.' What does the verse say Jesus was, for our transgressions and iniquities?", a: "Pierced and crushed (Isaiah 53:5)" },
  ...
  "Psalms & Proverbs": {
    ...
    600: [
      ...
      { q: "Psalm 51:10 is a prayer David prayed. What two things does he ask God to create and renew?", a: "A clean heart and a right spirit (Psalm 51:10)" },
    ...
    800: [
      ...
      { q: "Which Psalm did Jesus quote from the cross? And what is unique about this Psalm's ending compared to its dark opening?", a: "Psalm 22 — it opens in despair but ends in praise and victory" },
    ...
    1000: [
      ...
      { q: "Psalm 119 is structured as an acrostic — what does that mean and how many sections does it have?", a: "22 sections, each beginning with a successive letter of the Hebrew alphabet" },
      ...
      { q: "Which Psalm is quoted more in the New Testament than any other Old Testament passage?", a: "Psalm 110" },
      { q: "Psalm 22 begins 'My God, my God, why have you forsaken me' — Jesus quoted this on the cross. According to verse 24, what did God NOT do to the suffering one?", a: "He did not despise or ignore the suffering — He listened to the afflicted one's cry (Psalm 22:24)" },
      ...
      { q: "The Psalms are divided into 5 books, mirroring the 5 books of Moses. Which Psalm marks the beginning of Book 4?", a: "Psalm 90 (written by Moses)" },
    ],
  },
  "Creation & Genesis": {
    200: [
    ...
    600: [
      ...
      { q: "When Joseph revealed himself to his brothers, he said God had sent him ahead for a purpose. What did he say that purpose was?", a: "To save lives (Genesis 45:7)" },
    ...
    1000: [
      ...
      { q: "Genesis 3:15 is called the 'protoevangelium' — the first gospel. What does it say the 'seed of the woman' will do to the serpent?", a: "Crush the serpent's head (Genesis 3:15)" },
    ],
  },
  "Kings & Kingdoms": {
    200: [
    ...
    800: [
      ...
      { q: "David was not allowed to build the temple. What specific reason did God give — based on David's life of warfare?", a: "David was a man of blood who had shed much blood in war (1 Chronicles 22:8)" },
    ],
    1000: [
  ...
  "Paul's Letters": {
    200: [
      ...
      { q: "Paul wrote 'Do not be anxious about anything, but in everything by prayer and ___, with thanksgiving, present your requests to God.'", a: "Supplication (Philippians 4:6)" },
    ...
    400: [
      { q: "Romans 8:28 says 'all things work together for good' for those who meet what condition?", a: "Those who love God and are called according to His purpose" },
    ...
    800: [
      ...
      { q: "Paul wrote about the resurrection extensively in 1 Corinthians 15. What does he say would be true 'if Christ has not been raised'?", a: "Our faith is futile and we are still in our sins (1 Corinthians 15:17)" },
