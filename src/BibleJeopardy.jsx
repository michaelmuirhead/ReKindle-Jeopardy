...
/* ── Question Bank (12 categories × 5 tiers × 10 questions each) ── */
const QUESTION_BANK = {
  "Characters": {
    200: [
  ...
  "Life of Jesus": {
    200: [
      ...
      { q: "What was Jesus' trade or occupation before He began His public ministry?", a: "Carpenter (or carpenter's son, Mark 6:3)" },
      { q: "Who baptized Jesus in the Jordan River?", a: "John the Baptist" },
      { q: "What were Jesus' 12 special followers called?", a: "Disciples (or Apostles)" },
      { q: "What sea did Jesus walk on and calm a raging storm?", a: "The Sea of Galilee" },
      { q: "What special meal did Jesus share with His disciples the night before He was crucified?", a: "The Last Supper (or the Lord's Supper)" },
      { q: "Jesus was crucified between two other men. Who were they?", a: "Two criminals (thieves or robbers)" },
    ...
    400: [
      ...
      { q: "A Samaritan woman met Jesus at a well. What did Jesus offer her that was better than the well water?", a: "Living water (or eternal life, John 4)" },
    ...
    600: [
      ...
      { q: "Jesus stood before two rulers the morning He was crucified. Name either one of them.", a: "Pontius Pilate or Herod Antipas" },
    ...
    800: [
      ...
      { q: "Jesus raised three different people from the dead during His ministry. Name any one of them.", a: "Lazarus, Jairus's daughter, or the widow of Nain's son" },
  ...
  "Miracles": {
    ...
    600: [
      ...
      { q: "God opened the earth and it swallowed alive the men who led a rebellion against Moses. Name one of the three leaders.", a: "Korah, Dathan, or Abiram (Numbers 16)" },
    ],
    800: [
  ...
  "Numbers & Facts": {
    ...
    1000: [
      ...
      { q: "How many Beatitudes does Jesus list in the Sermon on the Mount in Matthew 5?", a: "8 Beatitudes (or 9 if you include verse 11)" },
      ...
      { q: "The book of Revelation is addressed to 7 churches. Name any three of them.", a: "Ephesus, Smyrna, Pergamum, Thyatira, Sardis, Philadelphia, Laodicea (Revelation 2-3)" },
  ...
  "Psalms & Proverbs": {
    200: [
      ...
      { q: "Proverbs 3:6 says 'In all your ways acknowledge Him, and He shall _____ your paths.' Fill in the blank.", a: "Direct (or make straight)" },
    ...
    400: [
      ...
      { q: "Proverbs 16:9 says 'In their hearts humans plan their course, but the Lord _____ their steps.'", a: "Establishes (or directs)" },
    ],
    600: [
      ...
      { q: "Proverbs 31:25 says a virtuous woman is clothed with strength and _____ and she laughs without fear of the future.", a: "Dignity (or honor)" },
      { q: "Psalm 1 says the blessed person is 'like a tree planted by _____ of water, which yields its fruit in season.'", a: "Streams" },
      { q: "Proverbs 11:2 says 'When pride comes, then comes _____; but with humility comes wisdom.'", a: "Disgrace (or shame)" },
    ...
    1000: [
      ...
      { q: "Proverbs was written primarily by Solomon, but two other authors contributed chapters. Name one.", a: "Agur (son of Jakeh, chapter 30) or King Lemuel's mother (chapter 31)" },
  ...
  "Creation & Genesis": {
    ...
    600: [
      ...
      { q: "God changed Jacob's name to Israel after he wrestled all night. What does the name Israel mean?", a: "'He struggles with God' or 'Prince with God' (Genesis 32:28)" },
    ...
    800: [
      ...
      { q: "Jacob had 12 sons who became the 12 tribes of Israel. Name any 5 of them.", a: "Reuben, Simeon, Levi, Judah, Dan, Naphtali, Gad, Asher, Issachar, Zebulun, Joseph, Benjamin" },
  ...
  "Kings & Kingdoms": {
    200: [
      ...
      { q: "King Nebuchadnezzar was the king of which powerful empire?", a: "Babylon (or the Babylonian Empire)" },
      ...
      { q: "Which king was so wicked that the Bible says there was 'no one like him' in his evil — he even sacrificed his own son?", a: "King Ahab (or Manasseh, who sacrificed his son — 2 Kings 21)" },
    ...
    1000: [
      ...
      { q: "Saul's kingdom was taken from him for two specific acts of disobedience. Name either of them.", a: "He offered a sacrifice instead of waiting for Samuel (1 Samuel 13) or he spared King Agag and kept plunder (1 Samuel 15)" },
      ...
      { q: "Name the five kings of Israel/Judah who are specifically said to have done what was right in the Lord's eyes.", a: "Asa, Jehoshaphat, Joash (Jehoash), Hezekiah, Josiah — sometimes also Amaziah" },
  ...
  "Paul's Letters": {
    ...
    600: [
      ...
      { q: "Paul wrote about speaking in tongues in 1 Corinthians. What did he say was greater than speaking in tongues without interpretation?", a: "Prophecy (or any gift that builds up the church) — (1 Corinthians 14:1-5)" },
